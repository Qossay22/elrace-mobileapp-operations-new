...
class TaskDetailsScreen extends StatelessWidget {
  ...
  TaskModel _resolveTask(TasksBloc provider) {
  ...
  Future<void> _showEditSheet(
      BuildContext context, TasksBloc provider, TaskModel currentTask) async {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<TasksBloc, TasksState>(
      builder: (context, state) {
        ...
        final reportsProvider = context.watch<ReportBloc>();
...
class _EditTaskSheetState extends State<_EditTaskSheet> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<TasksBloc, TasksState>(
      builder: (context, state) {
        final isUpdating = state.updatingTaskIds.contains(widget.task.id ?? -1);
                    ...
                    onPressed: isUpdating
                        ...
                        : () async {
                            ...
                            final msg = await widget.provider.updateTask(
                              ...
                              name:
                                  nameController.text.trim() == widget.task.name
                                      ? null
