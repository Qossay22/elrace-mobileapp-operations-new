...
Future<void> showFileRename(BuildContext context,
    {required PdfModel pdf}) async {
  TextEditingController renameController =
      TextEditingController(text: pdf.name.replaceFirst(".pdf", ""));
  await showDialog(
    context: context,
    barrierColor:
                  ...
                  Expanded(
                    child: MaterialButton(
                      onPressed: () async {
                        ...
                        // await renameFile(
                        //     pdf.path, "${renameController.text}.pdf");
                        await ReportRepository().saveReportPdf(pdf.copyWith(
                          name: "${renameController.text}.pdf",
                        ));
                        Navigator.pop(context);
                      },
                      height: 44,
