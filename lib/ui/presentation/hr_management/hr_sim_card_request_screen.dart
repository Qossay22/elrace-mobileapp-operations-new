...
class HrSimCardRequestScreen extends StatefulWidget {
  const HrSimCardRequestScreen({super.key});

  static const draftKey = 'hr_draft_sim_card_v1';

  @override
  State<HrSimCardRequestScreen> createState() => _HrSimCardRequestScreenState();
}

class _HrSimCardRequestScreenState extends State<HrSimCardRequestScreen> {
  ...
  void _loadDraft() {
    final raw =
        SharedPref().getPreferenceString(HrSimCardRequestScreen.draftKey);
  ...
  Future<void> _saveDraft() async {
    ...
    await SharedPref().setPreferencesString(
        HrSimCardRequestScreen.draftKey, jsonEncode(payload));
    if (mounted) {
              ...
              children: [
                ...
                Expanded(
                  child: FilledButton(
                    ...
                    child: Text(
                      'Submit Request',
                      style: HrModuleTypography.button()
